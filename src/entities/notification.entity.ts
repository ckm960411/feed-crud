...
export enum NotificationType {
  ...
  BAROPOT_PARTICIPANT_JOIN_REQUEST_REMOVED = 'BAROPOT_PARTICIPANT_JOIN_REQUEST_REMOVED',
  BAROPOT_PARTICIPANT_JOIN_REQUEST_CANCELLED = 'BAROPOT_PARTICIPANT_JOIN_REQUEST_CANCELLED',
}
